...
build(){
	...
	export SHELL_CFLAGS="-DSQLITE_NOHAVE_SYSTEM=0"
...
makeOutput(){
	...
	-arch x86_64 ${PREFIXDIR}/x86_64/lib/libsqlite3.a \
	-arch arm64 ${PREFIXDIR}/arm64/lib/libsqlite3.a \
	-arch armv7 ${PREFIXDIR}/armv7/lib/libsqlite3.a \
	-output $ROOT/output/lib/libsqlite3.a -create
#rm -R ${PREFIXDIR}
}
