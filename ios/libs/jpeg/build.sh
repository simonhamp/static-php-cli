...
makeOutput(){
	...
	-arch x86_64 ${PREFIXDIR}/x86_64/lib/libjpeg.a \
	-arch arm64 ${PREFIXDIR}/arm64/lib/libjpeg.a \
	-arch armv7 ${PREFIXDIR}/armv7/lib/libjpeg.a \
	-output $ROOT/output/lib/libjpeg.a -create
	#rm -R ${PREFIXDIR}
}
