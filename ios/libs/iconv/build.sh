...
makeOutput(){
	...
	-arch x86_64 ${PREFIXDIR}/x86_64/lib/libiconv.a \
	-arch arm64 ${PREFIXDIR}/arm64/lib/libiconv.a \
	-arch armv7 ${PREFIXDIR}/armv7/lib/libiconv.a \
	-output $ROOT/output/lib/libiconv.a -create

	${DEVROOT}/usr/bin/lipo \
	-arch x86_64 ${PREFIXDIR}/x86_64/lib/libcharset.a \
	-arch arm64 ${PREFIXDIR}/arm64/lib/libcharset.a \
	-arch armv7 ${PREFIXDIR}/armv7/lib/libcharset.a \
	-output $ROOT/output/lib/libcharset.a -create
	#rm -R ${PREFIXDIR}
}
